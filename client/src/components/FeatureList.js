...
<section className="my-5">
  ...
  <p className="lead grey-text text-center w-responsive mx-auto mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
    ...
    <div className="col-md-4">
      ...
      <div className="row mb-md-0 mb-3">
        ...
        <div className="col-10">
          ...
          <p className="grey-text mb-md-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam minima assumenda deleniti hic.</p>
        </div>
      </div>
    </div>
    ...
    <div className="col-md-4">
      ...
      <div className="row">
        ...
        <div className="col-10">
          ...
          <p className="grey-text mb-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam minima assumenda deleniti hic.</p>
        </div>
